<%@ Page Title="" Language="C#" MasterPageFile="~/Site1.Master" AutoEventWireup="true" CodeBehind="UpdateCourse.aspx.cs" Inherits="CRUD_Pract.UpdateCourse" %>
        ...
        <div class="row">
            <div class="col-md-6 mx-auto">
                ...
                <div class="row">
                    ...
                    <asp:Button CssClass="m-4 btn btn-block btn-outline-success" ID="CourseAddButton" runat="server" Text="Update Course" OnClick="CourseUpdateButton_Click" />
                </div>
            </div>
        </div>
    </div>
